...
public class Frm_ConsCliente extends javax.swing.JFrame {

    
    public Frm_ConsCliente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_ConsCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_ConsCliente().setVisible(true);
            }
        });
    }
